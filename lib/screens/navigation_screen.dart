...
class NavigationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Sitare'),centerTitle: true,),
      body: Center(
        child: SingleChildScrollView(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              NavigationButton(screen: CreateAccountScreen(),text: 'Create account screen',),
              const NavigationButton(screen: EnterDetailsScreen(),text: 'Enter details screen',),
              const NavigationButton(screen: FilterSectionSheet(),text: 'Filter section',),
              const NavigationButton(screen: HomeScreen(),text: 'Home screen',),
              const NavigationButton(screen: LoginEmailScreen(),text: 'Login with email',),
              const NavigationButton(screen: NextAvailabilityScreen(),text: 'next availability screen',),
              NavigationButton(screen: OrderHistoryScreen(),text: 'Order history',),
              NavigationButton(screen: OTPScreen(),text: 'otp screen',),
              NavigationButton(screen: PaymentScreen(),text: 'Payment information screen',),
              NavigationButton(screen: ProfileScreen(),text: 'Profile screen',),
              NavigationButton(screen: TalkToExpertsScreen(),text: 'Talk to experts screen',),
              const NavigationButton(screen: WalletRechargeScreen(),text: 'Wallet recharge',),
              NavigationButton(screen: WelcomeScreen(),text: 'Welcome screen',),
            ],
          ),
        ),
      ),
